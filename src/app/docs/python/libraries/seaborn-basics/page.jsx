  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-700 leading-relaxed">
        ...
        statistical graphics and makes it easy to create complex visualizations
        with minimal code.
      </p>
      ...
      <div className="space-y-10 text-slate-700 leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-2">
            Seaborn builds on top of Matplotlib and integrates closely with
            Pandas data structures, making it ideal for statistical
            visualizations and quick exploratory analysis.
          </p>
        ...
        <section>
          ...
          <p className="mt-2">Import Seaborn and common companions:</p>
...
sns.set_palette("husl")`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Seaborn comes with built-in datasets
...
print(tips.head())`}</pre>
        ...
        <section>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`tips = sns.load_dataset('tips')
...
plt.show()`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Create a figure with distribution
...
plt.show()`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Add rug plot to show individual observations
sns.kdeplot(data=tips, x='total_bill')
...
plt.show()`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Violin plot (combination of box and KDE)
...
plt.show()`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Swarm plot (shows all points)
...
plt.show()`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Line plot with confidence interval
...
plt.show()`}</pre>
        ...
        <section>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Regression plot with confidence interval
...
plt.show()`}</pre>
        ...
        <section>
          ...
          <h3 className="mt-3 text-xl font-semibold text-[#4a0080]">Heatmap</h3>
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
...
plt.show()`}</pre>
        ...
        <section>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Create multiple plots in one figure
...
plt.show()`}</pre>
          ...
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Figure-level functions create their own figure
...
plt.show()`}</pre>
        ...
        <section>
          ...
          <h3 className="mt-3 text-xl font-semibold text-[#4a0080]">Styling</h3>
          <div className="mt-2 border border-gray-200 bg-white rounded-lg p-4 font-mono text-sm leading-7 overflow-x-auto border-l-4 border-[#4a0080]">
            <pre>{`# Set style
...
# Custom scaling
sns.set_context("notebook", font_scale=1.5, rc={"lines.linewidth": 2.5})`}</pre>
          </div>
        </section>
...
plt.show()`}</pre>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-3 space-y-2">
            <li>
              <strong>Use appropriate plot types:</strong> Choose plots that
              best represent your data.
            </li>
            <li>
              <strong>Leverage hue and style:</strong> Add dimensions to your
              visualizations.
            </li>
            <li>
              <strong>Set themes early:</strong> Apply styling at the beginning
              of your script.
            </li>
            <li>
              <strong>Use figure-level functions for faceting:</strong> They
              handle subplot creation automatically.
            </li>
            <li>
              <strong>Choose colorblind-friendly palettes:</strong> Ensure
              accessibility.
            </li>
            <li>
              <strong>Add context with titles and labels:</strong> Make plots
              self-explanatory.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Seaborn simplifies the creation of beautiful statistical
            visualizations in Python. Built on top of Matplotlib, it provides
            intuitive high-level functions that make complex plots easy to
            create. Master Seaborn to quickly explore and communicate insights
            from your data.
          </p>
        </section>
      </div>
